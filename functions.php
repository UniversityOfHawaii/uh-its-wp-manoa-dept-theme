...
if ( ! function_exists( 'manoa2018_continue_reading_link' ) ) :
    ...
    function manoa2018_continue_reading_link() {
        return ' <a href="' . get_permalink() . '">' . __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'manoa2018' ) . '</a>';
    }
endif;
