 ...
 */
?>
  <form method="get" class="search-form" id="searchform-desktop" aria-hidden="false" action="<?php echo esc_url( home_url( '/' ) ); ?>">
    <label for="basic-site-search-desktop" class="assistive-text screen-reader-text"><?php _e( 'Search site', 'manoa2018' ); ?></label>
